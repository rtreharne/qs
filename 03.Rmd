...
1. **Download the CSV File:** 
   - Here is an [example dataset](https://raw.githubusercontent.com/rtreharne/qs/refs/heads/main/data/03/part_1/callibration_999999999.csv){target=_blank}. Download it to your local machine.
...
**1. Download the data**:
   ...
   - Here is an [example sunflower dataset](https://raw.githubusercontent.com/rtreharne/qs/refs/heads/main/data/03/part_2/sunflowers_999999999.csv){target=_blank
