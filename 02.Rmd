...
1. **Download the CSV File:** 
   - Here is an [example dataset](https://raw.githubusercontent.com/rtreharne/qs/refs/heads/main/data/02/zebrafish_999.csv){target=_blank}. Click the link, then right click and save as to download it to your local machine.
