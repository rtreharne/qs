...
In this section we will only be using Excel. No R today!

Specifically, you will be developing two important skills:
...
```
We call this format, in which each row corresponds to a single measure, a **long** format.
...
## Complete your Weekly Assignments {.complete-your-weekly-assignments-02}
