...
Fair enough. I understand that many of you will want to get stuck in immediately with RStudio and this week's exercises. If this is the case then you should do the following first:
...
If we do that, then we can complete our first sequence-analysis exercise. Hooray!
